...
namespace renoir_tuning_utility
{
    ...
    {
        [System.Runtime.InteropServices.DllImport("inpoutx64.dll")]
        ...
        [DllImport("inpoutx64.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool SetPhysLong(UIntPtr memAddress, uint DData);
        ...
        public void SetBclk2(double BCLK)
        {
            // disable ssc
            uint pdwPhysVal = 0;
            GetPhysLong((UIntPtr)0xFED80E08, ref pdwPhysVal); // cpu.io.GetPhysLong((UIntPtr)0xFED80E08, out uint value);
            pdwPhysVal = setbit2(pdwPhysVal, 0, 0, 0);
            SetPhysLong((UIntPtr)0xFED80E08, pdwPhysVal); // cpu.io.SetPhysLong((UIntPtr)0xFED80E08, ZenStates.Core.Utils.SetBits(value, 0, 0, 0));

            // CG1_FBDIV_LoadEn
            GetPhysLong((UIntPtr)0xFED80E40, ref pdwPhysVal); // cpu.io.GetPhysLong((UIntPtr)0xFED80E40, out value);
            pdwPhysVal = setbit2(pdwPhysVal, 1, 25, 25);
            SetPhysLong((UIntPtr)0xFED80E40, pdwPhysVal); // cpu.io.SetPhysLong((UIntPtr)0xFED80E40, ZenStates.Core.Utils.SetBits(value, 25, 1, 1));

            // Set bclk
            GetPhysLong((UIntPtr)0xFED80E10, ref pdwPhysVal); //cpu.io.GetPhysLong((UIntPtr)0xFED80E10, out value);
            ...
            SetPhysLong((UIntPtr)0xFED80E10, pdwPhysVal); // cpu.io.SetPhysLong((UIntPtr)0xFED80E10, value);

            GetPhysLong((UIntPtr)0xFED80E40, ref pdwPhysVal); //cpu.io.GetPhysLong((UIntPtr)0xFED80E40, out value);
            pdwPhysVal = setbit2(pdwPhysVal, 1, 30, 30);
            SetPhysLong((UIntPtr)0xFED80E40, pdwPhysVal); //cpu.io.SetPhysLong((UIntPtr)0xFED80E40, ZenStates.Core.Utils.SetBits(value, 30, 1, 1));
        }
